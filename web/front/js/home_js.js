...
(function() {
    ...
    PAYPAL.Marketing.HeaderMenu = function(menuButton, menuBar) {
        ...
        this._$optionalBanner = this._$body.find('.optional-banner');
    ...
    PAYPAL.Marketing.HeaderMenu.prototype = {
        ...
        _touchStart: function(e) {
            ...
            // If not in menu or optional banner, stop scroll and also disable all other links click
            if (!($(e.target).closest(this._$menu).length) && !($(e.target).closest(this._$optionalBanner).length)) {
                e.preventDefault();
            }
...
$(function() {
    ...
    $('#cookie-alert-close').on('click', function() {
        ...
        cookieHeight = 0;
        if (Storage !== undefined) localStorage.setItem('eu-cookie', 'true');
    ...
    var cookiestatus = '';
    if (Storage !== undefined) cookiestatus = JSON.parse(localStorage.getItem('eu-cookie'));
    if (!cookiestatus) {
...
$(function() {
    ...
    /* Replace X million users for global wide. */
    /* ex. <data class="active-digital-wallets"></data> million */

    var CONSTANTS = CONSTANTS || {};
    CONSTANTS['active-digital-wallets'] = 192;
    CONSTANTS['cn-simplified-pp-accts'] = 1.92;
    CONSTANTS['kr-pp-accts'] = '1ì–µ 9,200';

    CONSTANTS['million-buyers-english'] = 13.1;
    CONSTANTS['million-buyers-thai'] = 13.1;
    CONSTANTS['million-buyers-chinese'] = '1,310';
    CONSTANTS['million-buyers-korean'] = '1,310';
    CONSTANTS['million-buyers-indonesian'] = '13,1';
    ...
    CONSTANTS['number-transactions-emea'] = '4,9';
    ...
    $('data.million-buyers-english').html(CONSTANTS['million-buyers-english']);
    $('data.million-buyers-chinese').html(CONSTANTS['million-buyers-chinese']);
    $('data.million-buyers-indonesian').html(CONSTANTS['million-buyers-indonesian']);
    $('data.million-buyers-korean').html(CONSTANTS['million-buyers-korean']);
    $('data.million-buyers-thai').html(CONSTANTS['million-buyers-thai']);
    ...
    $('data.number-transactions-emea').html(CONSTANTS['number-transactions-emea']);
});

/* Add external pixel tracking after entire page is loaded.
 *
 * HTML:
 * <div class="hide externalTrackingSrc">www.yahoo.com/someURL</div>
 * <div class="hide externalTrackingSrc">www.google.com/someURL?something=blah</div>
