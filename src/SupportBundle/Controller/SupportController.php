    ...
    public function newTicketAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                $this->addFlash('success', $this->get('translator')->trans('office.support.ticket_sent_success'));

                return $this->redirectToRoute('new_ticket');
            } else {
                $this->addFlash('error', $this->get('translator')->trans('office.support.ticket_sent_error'));
            }
        }
    ...
    public function showTicketAction(Request $request, $id)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                $this->addFlash('success', $this->get('translator')->trans('office.support.mesage_sent_succces'));
